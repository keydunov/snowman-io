  ...
  class Launcher
    ...
    def start
      ...
      @main = Loop.supervise_as(:main, 3) {
        ...
        SnowmanIO.storage.metrics_register_value("[SYS] Aggregation Time", Time.now.to_f - start, system: true)
        ...
        SnowmanIO.storage.metrics_register_value("[SYS] Storage Size", SnowmanIO.mongo.db.stats["storageSize"], system: true)
      }
    end
